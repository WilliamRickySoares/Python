...
for t in tipos_processos:
    buscar_dados_info_plus = link + 'Areas/Empresarial/Empresarial.svc/json/LerCFRTs'
    ...
    lin = 0
    while True:
        descricao = dado_infoplus['BuscarDadosInfoPlusResponse']['BuscarDadosInfoPlusResult']['a:InfoPlus'][lin][
            'a:Descricao']
        grupo = dado_infoplus['BuscarDadosInfoPlusResponse']['BuscarDadosInfoPlusResult']['a:InfoPlus'][lin]['a:Grupo']
        id_header = dado_infoplus['BuscarDadosInfoPlusResponse']['BuscarDadosInfoPlusResult']['a:InfoPlus'][lin][
            'a:IdHeader']
        obrigatorio = dado_infoplus['BuscarDadosInfoPlusResponse']['BuscarDadosInfoPlusResult']['a:InfoPlus'][lin][
            'a:Obrigatorio']
        ...
        while True:
            ...
            codigo = \
                complementar_dict['LerInformacaoComplementarInfoPlusResponse'][
                    'LerInformacaoComplementarInfoPlusResult'][
                    'a:Codigo']
            complementar = \
                complementar_dict['LerInformacaoComplementarInfoPlusResponse'][
                    'LerInformacaoComplementarInfoPlusResult'][
